...
// Super Owner - User ID #5 (only account that can manage protected users)
export const SUPER_OWNER_NUMERIC_ID = 5;

// Protected user IDs that cannot be banned (except by Super Owner)
export const PROTECTED_USER_IDS = [1, 5]; // ID #1 (admin), ID #5 (BadDecisions/Owner)
